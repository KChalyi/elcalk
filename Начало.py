...
st.session_state["nap1"]=nap1
st.session_state["nap2"]=nap2
st.session_state["nap3"]=nap3
st.session_state["nap4"]=nap4
st.session_state["nap5"]=nap5
st.session_state["cos1"]=cos1
st.session_state["cos2"]=cos2
st.session_state["cos3"]=cos3
st.session_state["cos4"]=cos4
st.session_state["cos5"]=cos5
st.session_state["length1"]=length1
st.session_state["length2"]=length2
st.session_state["length3"]=length3
st.session_state["length4"]=length4
st.session_state["length5"]=length5
st.session_state["sech1"]=sel_sech[0]
st.session_state["sech2"]=sel_sech[1]
st.session_state["sech3"]=sel_sech[2]
st.session_state["sech4"]=sel_sech[3]
st.session_state["sech5"]=sel_sech[4]
st.session_state["mat1"]=sel_decks[0]
st.session_state["mat2"]=sel_decks[1]
st.session_state["mat3"]=sel_decks[2]
st.session_state["mat4"]=sel_decks[3]
st.session_state["mat5"]=sel_decks[4]
